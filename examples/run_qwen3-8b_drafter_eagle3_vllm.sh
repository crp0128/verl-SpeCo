...
# GPU example for the native EAGLE3 proposer in vLLM.
project_name='verl_grpo_example_eagle3_drafter'
exp_name='qwen3_8b_eagle3_drafter_vllm_gpu'
...
PYTHONUNBUFFERED=1 python3 -m verl_speco.main \
    ...
    actor_rollout_ref.rollout.drafter.training.publish_interval_steps=5 \
